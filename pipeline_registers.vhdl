...
entity pipeline_registers is
    Port (
        ...
        id_ex_instr : inout STD_LOGIC_VECTOR(31 downto 0); --changed from out
        ...
        ex_mem_branch : inout STD_LOGIC; --chnaged from out
        ex_mem_jump : inout STD_LOGIC; --changed from out
...
begin
    ...
    begin
        if (reset = '1') then
            ...
            ex_mem_npc <= (others => '0');--npc
            ex_mem_alu_result <= (others => '0');--alu_result
            ex_mem_alu_op <= (others => '0');--alu_op
            ...
            mem_wb_npc <= (others => '0');--npc
            mem_wb_alu_result <= (others => '0');--alu_result
            mem_wb_alu_op <= (others => '0');--alu_op
